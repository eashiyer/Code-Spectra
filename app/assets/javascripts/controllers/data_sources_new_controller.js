/** 
*@class Cibi.ChartsDataSourcesController
*/

/**
  `Cibi.ChartsDataSourcesController` is the controller class for array of objects of type `ChartsDataSource`
...
*/
Cibi.ChartsDataSourcesNewController = Ember.ObjectController.extend({
	//needs: ['dataSources'],
});