...
/**
  ...
  @module charts
*/
Cibi.GeoMapIndia = Ember.Object.extend({
    ...
    */
    ...
    _drawGeoChart: function(data, self){
      ...
      var topology_file = "/data/india-states.json";
      
      // load and display the World
      d3.json(topology_file, function(error, topology) {
          obj.drawIndia(g, projection, path, topology,tip);        
      });        
   ...
   /**
      ...
      @method drawIndia
    */
    drawIndia: function(g, projection, path, topology,tip) {
      var obj = this;
      var width = 620; // obj.chart.get('width');
      var height = 650; // obj.chart.get('height');
      projection.center([width / 6.8, 25])
      .scale(1200);
      var india_states = g.append("g")
                          .attr('id', 'states');

      var india_places = g.append("g")
                          .attr('id', 'places');
        obj.drawShapes(india_states, topojson.object(topology, topology.objects.states).geometries, path,tip);
        obj.drawPlaces(india_places, projection,tip);
    ...
    */
    getShapeName: function(d) {
      var obj = this;
        ...
        var short_name = d.id.toLowerCase() ;
